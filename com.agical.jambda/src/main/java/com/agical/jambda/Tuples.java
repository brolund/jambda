...
public class Tuples {
    ...
    public static <T1, T2, T3> Tuple3<T1, T2, T3> trio(T1 t1, T2 t2, T3 t3 ) {
        return new Tuple3<T1, T2, T3> (t1, t2, t3);
    };
    
    public static <T1, T2, T3, T4> Tuple4<T1, T2, T3, T4> quartet(T1 t1, T2 t2, T3 t3, T4 t4 ) {
        return new Tuple4<T1, T2, T3, T4> (t1, t2, t3, t4);
    };
    
    public static <T1, T2, T3, T4, T5> Tuple5<T1, T2, T3, T4, T5> quintet(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5) {
        return new Tuple5<T1, T2, T3, T4, T5> (t1, t2, t3, t4, t5);
    };
    
    public static <T1, T2, T3, T4, T5, T6> Tuple6<T1, T2, T3, T4, T5, T6> sextet(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
